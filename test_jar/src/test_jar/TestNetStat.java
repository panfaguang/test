...
class TcpUtil {
    public String printTcpConn() throws IOException {
        ...
        transport.listen();
        Address targetAddress = GenericAddress.parse("udp:192.168.1.241/161");
        ...
        tutils.setMaxNumRowsPerPDU(7);
        OID columnOID[] = new OID[7];
        ...
        columnOID[3] = new OID("1.3.6.1.2.1.25.2.3.1.4");
        columnOID[4] = new OID("1.3.6.1.2.1.25.2.3.1.5");
        columnOID[5] = new OID("1.3.6.1.2.1.25.2.3.1.6");
        columnOID[6] = new OID("1.3.6.1.2.1.25.2.3.1.7");
        ...
        for (int i = 0; i < tabEveNum; i++) {
            ...
            System.out.print(varBindings[2].getVariable().toString().substring(0, 4) + "\t");
