    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int n = 0; n < hosts.length; n++) {
                System.out.println(((HostSystem) hosts[n]).getSummary().getQuickStats().overallMemoryUsage);
                System.out.println(((HostSystem) hosts[n]).getHardware().getMemorySize() / 1024 / 1024);
