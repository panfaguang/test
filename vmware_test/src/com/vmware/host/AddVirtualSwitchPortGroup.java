 ...
 *vsiwtchid        [required] : Name of the VSwitch to add portgroup to
 ...
 *
 *Add Virtual switch Port Group without hostname
 *run.bat com.vmware.host.AddVirtualSwitchPortGroup
 *--url [webserviceurl] --username [username] --password  [password]
 *--vsiwtchid [mySwitch] --datacentername [mydatacenter]
 *--portgroupname [myportgroup]
 *
 *Add Virtual switch Port Group without datacentername
 *run.bat com.vmware.host.AddVirtualSwitchPortGroup
 *--url [webserviceurl] --username [username] --password  [password]
 *--vswitchid [mySwitch] --portgroupname [myportgroup]
 *</pre>
 */
...
public class AddVirtualSwitchPortGroup {
   ...
   private static void getInputParameters(String[] args) {
      ...
      if (portgroupname == null || virtualswitchid == null) {
         throw new IllegalArgumentException(
         "Expected --portgroupname,--virtualswitchid arguments properly");
      }
   }
   ...
   */
   ...
   private static void addVirtualSwitchPortGroup() throws Exception {
   ...
   private static void printUsage() {
      System.out.println("This sample is used to add a Virtual Switch PortGroup");
      System.out.println("\nParameters:");
      ...
      System.out.println("vswitchid        [required] : Name of the VSwitch to add portgroup to");
      ...
      System.out.println("\nCommand:");
      System.out.println("Add Virtual switch Port Group:");
      System.out.println("run.bat com.vmware.host.AddVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password  [password]");
      System.out.println("--vswitchid [mySwitch] --datacentername [mydatacenter]");
      System.out.println("--portgroupname [myportgroup] --hostname [hostname]");
      System.out.println("Add Virtual switch Port Group without hostname");
      System.out.println("run.bat com.vmware.host.AddVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password  [password]");
      System.out.println("--vsiwtchid [mySwitch] --datacentername [mydatacenter]");
      System.out.println("--portgroupname [myportgroup]");
      System.out.println("Add Virtual switch Port Group without datacentername");
      System.out.println("run.bat com.vmware.host.AddVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password  [password]");
      System.out.println("--vswitchid [mySwitch] --portgroupname [myportgroup]");
   }
