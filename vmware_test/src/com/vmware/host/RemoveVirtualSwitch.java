 ...
 *--vsiwtchid [mySwitch] --datacentername [mydatacenter] --hostname [hostname]
 *</pre>
 */
...
public class RemoveVirtualSwitch {
   ...
   private static void getInputParameters(String[] args) {
      ...
      while (ai < args.length) {
         ...
         if (param.equalsIgnoreCase("--vsiwtchid") && !val.startsWith("--")
               && !val.isEmpty()) {
            virtualswitchid = val;
         }
         val = "";
      ...
      if (virtualswitchid == null) {
         throw new IllegalArgumentException(
         "Expected --virtualswitchid argument properly");
      }
   }
   ...
   */
   ...
   private static void removeVirtualSwitch() {
   ...
   private static void printUsage() {
      ...
      System.out.println("vsiwtchid       [required] : Name of the switch to be added");
      ...
      System.out.println("run.bat com.vmware.host.RemoveVirtualSwitch --url [webserviceurl]");
      System.out.println("--username [username] --password  [password]");
      System.out.println("--vsiwtchid [mySwitch]"
            + "--datacentername [mydatacenter] --hostname [hostname]");
   }
