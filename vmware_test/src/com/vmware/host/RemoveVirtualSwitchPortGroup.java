 ...
 *--datacentername [mydatacenter] --portgroupname[<myportgroup] --hostname <hostname>
 *
 *Remove Virtual Switch Port Group without hostname
 *run.bat com.vmware.host.RemoveVirtualSwitchPortGroup
 *--url [webserviceurl] --username [username] --password [password]
 *--datacentername [mydatacenter] --portgroupname [myportgroup]
 *
 *Remove Virtual Switch Port Group without datacentername
 *run.bat com.vmware.host.RemoveVirtualSwitchPortGroup
 *--url [webserviceurl] --username [username] --password [password]
...
public class RemoveVirtualSwitchPortGroup {
   ...
   private static void getInputParameters(String[] args) {
      ...
      if (portgroupname == null) {
         throw new IllegalArgumentException(
         "Expected --portgroupname argument properly");
      }
   }
   ...
   */
    ...
    * @return ManagedObjectReference spec for the virtual machine
    */
   private static Object getHostNetworkInfoByNetworkSystem(ManagedObjectReference nwsystemmor)
      throws Exception {
      return getDynamicProperty(nwsystemmor, "networkInfo");
   }
         ...
         if (hostmor != null) {
            try {
               ...
               HostNetworkInfo netInfo =
                 (HostNetworkInfo) getHostNetworkInfoByNetworkSystem(nwSystem);
               vimPort.removePortGroup(nwSystem, portgroupname);
               System.out.println(" : Successful removing portgroup " + portgroupname);
   ...
   private static void printUsage() {
      ...
      System.out.println("portgroupname   [required] : Name of the port group to be removed");
      ...
      System.out.println("run.bat com.vmware.host.RemoveVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password [password]");
      System.out.println("--datacentername [mydatacenter] --portgroupname[<myportgroup] --hostname <hostname>");
      System.out.println("Remove Virtual Switch Port Group without hostname");
      System.out.println("run.bat com.vmware.host.RemoveVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password [password]");
      System.out.println("--datacentername [mydatacenter] --portgroupname [myportgroup]");
      System.out.println("Remove Virtual Switch Port Group without datacentername");
      System.out.println("run.bat com.vmware.host.RemoveVirtualSwitchPortGroup");
      System.out.println("--url [webserviceurl] --username [username] --password [password]");
