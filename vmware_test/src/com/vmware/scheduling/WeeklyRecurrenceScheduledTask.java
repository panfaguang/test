 ...
 *--vmname [VM name] --taskname [TaskToBeDeleted]
 *</pre>
 */
...
public class WeeklyRecurrenceScheduledTask {
   ...
   *
   * Trust all server certificates for sample usage.
   ...
   */
   ...
   private static void getInputParameters(String[] args)
      ...
      while (ai < args.length) {
         ...
         if (param.equalsIgnoreCase("--taskname")
               && !val.startsWith("--") && !val.isEmpty()) {
            taskName = val;
      ...
      if (taskName == null || vmName == null) {
         throw new IllegalArgumentException("Expected --taskname and --vmname argument.");
      }
   }
   ...
   */
    ...
    * @throws Exception
    */
   private void createScheduledTask(Action taskAction,
      ...
      try {
         ...
         ManagedObjectReference task =
            vimPort.createScheduledTask(scheduleManager,
                                        virtualMachine,
                                        scheduleSpec);
   ...
   private static void printUsage() {
      ...
      System.out.println("vmname       [required] : virtual machine to be powered off");
      System.out.println("taskname     [required] : Name of the task to be deleted");
      System.out.println("\nCommand:");
      System.out.println("run.bat com.vmware.scheduling.WeeklyRecurrenceScheduledTask" +
         "--url [webserviceurl] --username [username] --password [password]" +
         " --vmname [VM name] --taskname [TaskToBeDeleted]");
   }
