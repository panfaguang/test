 ...
 *
 *<b>Command Line:</b>
 *run.bat com.vmware.samples.simpleagent.CreateUser --server [myServerName] --url [URLString]
...
public class CreateUser {
   ...
   private static void createUser() throws Exception {
      ...
      permissions.add(per);
      vimPort.setEntityPermissions(hostAuthorizationManager,
                                   rootFolder,
                                   permissions);
   ...
   private static void customValidate() throws Exception {
      ...
      if(apiType.equalsIgnoreCase("VirtualCenter")) {
         ...
         throw new IllegalArgumentException("CreateUser does not run on vCenter Server");
      }
   }
   ...
   private static void printUsage() {
      ...
      System.out.println("server           [optional] : server for which username and password are to be added");
      System.out.println("\nCommand:");
      System.out.println("run.bat com.vmware.samples.simpleagent.CreateUser " +
