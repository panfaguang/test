 ...
 *Note that this sample does not use the apputils helper classes to create
 ...
 *
 *<b>Command Line:</b>
 *run.bat com.vmware.samples.simpleagent.SimpleAgent --hostName [myServerName]
 *</pre>
 */
public class SimpleAgent {
   ...
   private static void printUsage() {
      System.out.println("The SimpleAgent class uses the local credential store to obtain " +
         "user account and password information, for automated logon to the target host system");
      System.out.println("\nParameters:");
      System.out.println("hostname         [required] : The fully-qualified domain name of the server.");
      System.out.println("\nCommand:");
      System.out.println("run.bat com.vmware.samples.simpleagent.SimpleAgent –-hostName targetserver");
   }
